...
function loadAllSL(){
	...
	//$("#sltbl").empty();
	$.ajax({
		url: myurl+"getAllELData/"+activeNavBar,
        type: 'POST',        
        data: '', 
        cache:false,
        beforeSend: function(xhr) {  
        ...
        success:function(response){ 
			...
			attendedhtmlText += '<tr><td colspan=7 align=right><input type=button value="Submit All" onclick="performAction()" ></td></tr>';

		  	attendedhtmlText += '<td width="5%"><font face="arial" size="2" colo="#2c2c2c"><b>Sr.no</font></td>';
		  	attendedhtmlText += '<td width="25%"><font face="arial" size="2" color="#2c2c2c" ><b>Query</font></td>';
		  	attendedhtmlText += '<td width="7%"><font face="arial" size="2" color="#2c2c2c" ><b>Category</font></td>';
		  	attendedhtmlText += '<td width="7%"><font face="arial" size="2" color="#2c2c2c" ><b>Class Type</font></td>';
		  	attendedhtmlText += '<td width="40%"><font face="arial" size="2" color="#2c2c2c" ><b>Resolution</font></td>';
		  	attendedhtmlText += '<td width="5%"><font face="arial" size="2" color="#2c2c2c" ><b>Status</font></td>';
			...
			unAttendedhtmlText += '<tr><td colspan=7 align=right><input type=button value="Submit All" onclick="performAction()" ></td></tr>';

		  	unAttendedhtmlText += '<td width="5%"><font face="arial" size="2" colo="#2c2c2c"><b>Sr.no</font></td>';
		  	unAttendedhtmlText += '<td width="25%"><font face="arial" size="2" color="#2c2c2c" ><b>Query</font></td>';
		  	unAttendedhtmlText += '<td width="7%"><font face="arial" size="2" color="#2c2c2c" ><b>Category</font></td>';
		  	unAttendedhtmlText += '<td width="7%"><font face="arial" size="2" color="#2c2c2c" ><b>Class Type</font></td>';
		  	unAttendedhtmlText += '<td width="40%"><font face="arial" size="2" color="#2c2c2c" ><b>Resolution</font></td>';
		  	unAttendedhtmlText += '<td width="5%"><font face="arial" size="2" color="#2c2c2c" ><b>Status</font></td>';
		  	//htmlText += '<td width="20%"><font face="arial" size="2" color="#2c2c2c" ><b>Recommendation</font></td>';
		  	//htmlText += '<td width="10%"><font face="arial" size="2" color="#2c2c2c" ><b>Action</font></td>';
		  	unAttendedhtmlText += '</thead></tr>';
			...
			var status="";
		  		if((activeNavBar == "past" && (obj.Status == "1" || obj.Status == "2")) || (activeNavBar == "present" && (obj.Status != "1" && obj.Status != "2")))
				{
		  			status = "Approved";
					if(activeNavBar == "present" && (obj.Status != "1" && obj.Status != "2"))
						status = "";
					else
					{
					   if(obj.Status == "1")
					...
					unAttendedhtmlText += '<input type="hidden" id="inputText' + count +'" value="'+ obj.Question +'">';
		  		unAttendedhtmlText += '<input type="hidden" id="transId' + count +'" value="'+ obj.Category +'">';
		  		unAttendedhtmlText += '<input type="hidden" id="ontologyNode' + count +'" value="'+ obj.ClassType +'">';
		  		unAttendedhtmlText += '<input type="hidden" id="recWords22' + count +'" value="'+ obj.Answer +'">';
		  		unAttendedhtmlText += '<input type="hidden" id="status' + count +'" value="'+ status +'">';
		  		unAttendedhtmlText += '<input type="hidden" id="LearningId' + count +'" value="'+ obj.LearningId +'">';
		  		// += '<input type="hidden" id="ontologyFileName' + count +'" value="'+ obj.ontologyFileName +'">';
		  		
		  		unAttendedhtmlText += '<tr bgcolor="#FFFFFF">';
		  		unAttendedhtmlText += '<td><font face="arial" size="2">' + count + '</font></td>';
		  		unAttendedhtmlText += '<td style="word-wrap: break-word;"><font face="arial" size="2">'+ obj.Question +'</font></td>';
		  		unAttendedhtmlText += '<td style="word-wrap: break-word;"><font face="arial" size="2">'+ obj.Category +'</font></td>';
		  		unAttendedhtmlText += '<td style="word-wrap: break-word;"><font face="arial" size="2">'+ obj.ClassType +'</font></td>';
		  		unAttendedhtmlText += '<td style="word-wrap: break-word;"><font face="arial" size="2">'+ '<textarea id="recWords' + count +'" rows="4" cols="70" >'+ obj.Answer +'</textarea>' +'</font></td>';
		  		unAttendedhtmlText += '<td style="word-wrap: break-word;"><font face="arial" size="2">'+ status +'</font></td>';
		  		//htmlText += '<td style="word-wrap: break-word;"><font face="arial" size="2"><div id=words' + count + '>' + obj.UDF2 + '</div></font></td>';

		  		unAttendedhtmlText += '<td style="word-wrap: break-word;"><font face="arial" size="2">'
		  		unAttendedhtmlText += '<table border="0" cellspacing="2" cellpadding="2" width="100%" >';
				
				unAttendedhtmlText += '<tr><td colspan=2>';
		  		unAttendedhtmlText += '<input type=checkbox id="Accept_' + count + '"><font face="arial" size="2" color=green>Accept';
		  		unAttendedhtmlText += '</td></tr>';
		  		
		  		unAttendedhtmlText += '<tr><td colspan=2>';
		  		unAttendedhtmlText += '<input type=checkbox id="Reject' + count + '"><font face="arial" size="2" color=red>Reject';
		  		unAttendedhtmlText += '</td></tr>';
		  		unAttendedhtmlText += '</table>';
			  	unAttendedhtmlText += '</font></td>';
		  		...
		  		unAttendedhtmlText += '</tr>';
				
					
				}
		  		var todayDate = moment();
                var learningDate = moment(obj.createdDate);
		  		if((activeNavBar == "past" && obj.Status == "2") || (activeNavBar == "present" && !todayDate.isSame(learningDate,'day')))
				{
		  			status = "Rejected";
					...
					attendedhtmlText += '<input type="hidden" id="inputText' + count +'" value="'+ obj.Question +'">';
		  		attendedhtmlText += '<input type="hidden" id="transId' + count +'" value="'+ obj.Category +'">';
		  		attendedhtmlText += '<input type="hidden" id="ontologyNode' + count +'" value="'+ obj.ClassType +'">';
		  		attendedhtmlText += '<input type="hidden" id="recWords22' + count +'" value="'+ obj.Answer +'">';
		  		attendedhtmlText += '<input type="hidden" id="status' + count +'" value="'+ status +'">';
		  		attendedhtmlText += '<input type="hidden" id="LearningId' + count +'" value="'+ obj.LearningId +'">';
		  		// += '<input type="hidden" id="ontologyFileName' + count +'" value="'+ obj.ontologyFileName +'">';
		  		
		  		attendedhtmlText += '<tr bgcolor="#FFFFFF">';
		  		attendedhtmlText += '<td><font face="arial" size="2">' + count + '</font></td>';
		  		attendedhtmlText += '<td style="word-wrap: break-word;"><font face="arial" size="2">'+ obj.Question +'</font></td>';
		  		attendedhtmlText += '<td style="word-wrap: break-word;"><font face="arial" size="2">'+ obj.Category +'</font></td>';
		  		attendedhtmlText += '<td style="word-wrap: break-word;"><font face="arial" size="2">'+ obj.ClassType +'</font></td>';
		  		attendedhtmlText += '<td style="word-wrap: break-word;"><font face="arial" size="2">'+ '<textarea id="recWords' + count +'" rows="4" cols="70" >'+ obj.Answer +'</textarea>' +'</font></td>';
		  		attendedhtmlText += '<td style="word-wrap: break-word;"><font face="arial" size="2">'+ status +'</font></td>';
		  		//htmlText += '<td style="word-wrap: break-word;"><font face="arial" size="2"><div id=words' + count + '>' + obj.UDF2 + '</div></font></td>';

		  		attendedhtmlText += '<td style="word-wrap: break-word;"><font face="arial" size="2">'
		  		attendedhtmlText += '<table border="0" cellspacing="2" cellpadding="2" width="100%" >';
				
				attendedhtmlText += '<tr><td colspan=2>';
		  		attendedhtmlText += '<input type=checkbox id="Accept_' + count + '"><font face="arial" size="2" color=green>Accept';
		  		attendedhtmlText += '</td></tr>';
		  		
		  		attendedhtmlText += '<tr><td colspan=2>';
		  		attendedhtmlText += '<input type=checkbox id="Reject' + count + '"><font face="arial" size="2" color=red>Reject';
		  		attendedhtmlText += '</td></tr>';
		  		attendedhtmlText += '</table>';
			  	attendedhtmlText += '</font></td>';
		  		//htmlText += '<td style="word-wrap: break-word;"><font face="arial" size="2"><input type=checkbox id="Accept' + count + '"> Accept <br> <input type=checkbox id="Reject' + count + '"> Reject</td>';
		  		attendedhtmlText += '</tr>';
...
function saveToDB(count,approve){
	var query=$("#inputText"+count).val();
	var category=$("#transId"+count).val();
	var classtype=$("#ontologyNode"+count).val();
	var answer=$("#recWords"+count).val();
	var learningID=$("#LearningId"+count).val();
	var statusVal;
	if(approve == true)
		statusVal = 1;
	else
	...
	var json={"Category": category ,"ClassType": classtype ,"Question": query,"Answer":answer,"LearningId":learningID,"Status":statusVal};
	$.ajax({
        url: myurl+"updateELData",
        type: 'POST',        
        data: JSON.stringify(json), 
        cache:false,
        beforeSend: function(xhr) {  
