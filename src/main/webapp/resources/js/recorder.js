(function(window){
  ...
  var RECORDER_WORKER_PATH  = 'resources/js/recorderWorker.js';
  var ENCODER_WORKER_PATH   = 'resources/js/mp3Worker.js';


  var MP3Recorder = function(context, stream, cfg) {
    var config      = cfg || { statusContainer: null, statusMethod: 'replace' }
