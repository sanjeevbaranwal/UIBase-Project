 ...
 var userInputArray = [];
 var spellCorrectionImgSrc = "";
 var spellCorrectionImgSwapSrc = "";
 var spellSuggestionImgSrc = "";
 var spellSuggestionImgSwapSrc = "";
 var autoCompleteImgSrc = "";
 var autoCompleteImgSwapSrc = "";
 var useGoogleMicImgSrc = "";
 var useGoogleMicImgSwapSrc = "";
 var useNgGenieMicImgSrc = "";
 var useNgGenieMicImgSwapSrc = "";
 var clearChatImgSrc = "";
 var clearChatImgSwapSrc = "";
 var showChatInitValue = "";
 var iframeRequiredHeight = "";
 var showSeparator = false;
 var isGenieSpeakingCheckEnabled = false;
 var chatCEURL = "";
 var ismultiInstance = "";
 var rsmeGrpName = "RSME";
 var rsmePrgName = "RSMEDEMO";
 var rsmeSkillName = "RSME";
 var brandName = "mybuddy";
 ...
 function greeting() {
     ...
     if (window.location.href.indexOf("email") != -1) {
         if (msgTitle == "") {
             ...
             $("#genieText").text(greetings + " " + $('#loginusername').val() + ", I am mybuddy, I am here to help you with the issue you sent in email with subject :" + msgTitle);
         }
     } else {
 ...
 $(function() {
     ...
     var footer = '<div id="queryArea"><table id="tblQueryArea" style="width: 100%;height: 100%; background-color: white;"><tr style="border-top: 1px solid black;"><td style="width:100%;"><textarea id="userInputText" placeholder="Ask Away Anything" style="resize:none; border: 0; outline: none; height:80%;" onkeydown="if (event.keyCode == 32) { return callSpellCheckAjax(event); }" onkeyup="if (event.keyCode == 13) { return callSpellCheckAjax(event); }"></textarea></td><td><div><input type="image" id="sendUserTextBtn" src="resources/images/Send-Default.png" name="Ask mybuddy" value="Submit" onclick="return callSpellCheckAjax(event);"><br></div></td><td><div style="margin-left:5%;display:none"><input type="image" id="record" src="resources/images/audio.gif" name="Recording" value="Submit"  onclick="return stoprecording(event);" style="height: 50px;width: 50px;"><br></div></td><td><div style="margin-left:5%;display:block"><input type="image" id="startrecord" src="resources/images/OffMic.png" name="Start Recording" value="start" onclick="return startrecording(event);" style="height: 50px;width: 50px;"><br></div></td></tr></table></div>';
     //var footer = '<div id="queryArea"><table id="tblQueryArea" style="width: 100%;height: 75px; background-color: rgb(204, 204, 204);"><tr><td><div id="userInputText"  contenteditable="true" style="width: 300px; max-width: 300px;overflow-x: hidden;overflow-y: scroll;word-break: break-all" onkeydown="if (event.keyCode == 32) { return callSpellCheckAjax(); }" onkeydown="if (event.keyCode == 13) { return callFAQAjax(event); }"></div></td><td><div style="margin-left:25%"><input type="image" src="resources/images/sendbt.png" name="Ask Genie" value="Submit" onclick="return callFAQAjax(event);" style="height: 50px;width: 50px;"><br></div></td></tr></table></div>';
...
*/
     ...
     $("#opener").click(function() {
         ...
         $('#overlay').fadeIn('fast', function() {
             ...
             if ($(window).width() <= 680) {
                 ...
                 setTimeout(function() {
                     $(".ui-dialog").css("left", 250);
                 }, 900);
                 /*                  setTimeout(function() {
                                      $(".ui-dialog").css("left", 750);
                                  }, 900); */
                 setTimeout(function() {
                     showChat(true);
                 }, 1000);
     ...
     $(document).ready(function() {
         ...
         if (isMobile.any()) {
             ...
             setTimeout(function() {
                 document.getElementById("minimizeButton").style.visibility = "hidden";
             }, 1000);
         ...
         resize: function(event, ui) {
             setTimeout(function() {
                 ...
                 if ($("#alert_effect").is(':visible')) {
                     ...
                     changeFormLocation();
                 } else if ($("#form_effect_for_SME").is(':visible')) {
                     showChatresizer();
                     changeFormLocation();
 ...
 */
 ...
 function softwareInstallFormAjax(e) {
     ...
     var formSoftwareInstallJson = {
         "employeeEmailId": employeeId,
         "computerId": computerId,
         "softwareNameVersion": softwareNameVersion,
 ...
 function internetFormAjax(e) {
     ...
     var internetDetailsJson = {
         "employeeEmailId": employeeId,
         "computerId": computerId,
         "internetIssueDecription": internetIssueDecription,
         "internetBrowserName": internetBrowserName,
 ...
 function printerDetailsFormAjax(e) {
     ...
     var printerDetailsJson = {
         "employeeEmailId": employeeId,
         "printerMake": printerMake,
         "printerModel": printerModel,
         "printerError": printerError,
         "printerLocation": printerLocation,
         "printerBuilding": printerBuilding,
         "printerFloor": printerFloor,
         "printerHostName": printerHostName,
         "printerServerName": printerServerName,
 ...
 function UnsupportedCategoryFormAjax(e) {
     ...
     //var printerDetailsJson = {"employeeId" : employeeId,"printerMake" : printerMake,"printerModel" : printerModel,"printerType" : printerType,"printerError" : printerError,"buildingFloor" : buildingFloor,"printerSerialNumber" : printerSerialNumber,"printerDeptName" : printerDeptName,"printerIP" : printerIP,"contactNo" : contactNo};
     var unsupportedCategoryDetailsJson = {
         "employeeEmailId": employeeId,
         "computerId": computerId,
         "unsupportedErrorDescription": unsupportedErrorDescription,
         "unsupportedAdditionalRemarks": unsupportedAdditionalRemarks,
         "contactNo": contactNo,
         "transactionId": transactionId
     };
     $.ajax({
 ...
 var rsmeTeam;
 var userticketId;
 var initializeFireBase = true;
 var issecondInit = false;
 var issecondAvailInit = false;
 var liveRes;
 var startCallTime;
 var classifierdomain;
 var isnonOntoResGen;
 var expertTransactionId;
 var rsmeWindow;
 var isNonOntoWorkflow;
 var scriptId;
 ...
 function callFAQAjax(e) {
     ...
     /*clear chat image logic*/
     if (userInputText.replace(/([ ])/gi, '').length > 0) {
         userInputArray.push(userInputText);
         noOfPrevUserInput = userInputArray.length;
         var isDuplicate = false;
         var tempUserInputText = userInputText.toLowerCase().replace(/([,<.>'";:{}|\[\]\/\\])/gi, '');
         for (var i = 0; i < userInputArray.length - 1; i++) {
             if (tempUserInputText == userInputArray[i].toLowerCase()) {
                 isDuplicate = true;
                 userInputArray.pop(); //remove the duplicated element added to the array.
                 noOfPrevUserInput--;
                 break;
             }
         }
         if (!isDuplicate) {
             //$('#userInputTextSelect option[value="select"]').remove();
             //$('#userInputTextSelect').append($(document.createElement("option")).attr("value",noOfPrevUserInput-1).text(userInputText));
             $('#userInputTextSelect').append('<option value ="' + parseInt(noOfPrevUserInput - 1) + '">' + userInputText + '</option>');
             $('#userInputTextSelect option[value=' + parseInt(noOfPrevUserInput - 1) + ']').prop('selected', true);
         }
     }

     if (userInputArray.length == 0 && $("#transactionId").val().length == 0) {
         $('.clearchatbutton').attr('src', 'resources/images/ClearChat-Disabled.png').attr('data-swap', 'resources/images/ClearChat-Enabled.png');
         $('.ClearChatRow').css('pointer-events', 'none');
     } else {
         $('.clearchatbutton').attr('src', 'resources/images/ClearChat-Enabled.png').attr('data-swap', 'resources/images/ClearChat-Disabled.png');
         $('.ClearChatRow').css('pointer-events', '');
     }
     ...
     if (isLiveChat) {
         ...
         fixScroll();
         firebase.database().ref(rsmeGrpName).child("messages").child(expert + "_chatID").push(msg);
         submitLiveChatData(expertTransactionId, "<font color=#00A8FF size=2 face=verdana >$user : </font>" + newUserInputText)
         isRequestSend = 0;
         return;
     }
     ...
     json = {
         "errorText": errorText,
         "userInputText": newUserInputText,
         "id": id,
         "errorCode": errorCode,
         "transactionId": transactionId,
         "userId": userId,
         ...
         "isNonOntoResGen": isnonOntoResGen,
         "isNonOntoWorkflow":isNonOntoWorkflow,
         "scriptId":scriptId
     };
     ...
     if (!isUserRating) {
         ...
         if(ismultiInstance == "")
         {
        	 ismultiInstance = getconfigParam("ismultiinstance"); 
         }
         
         if(ismultiInstance == "true")
         {
         if(transactionId == "")
        	 getClassifierDomain(newUserInputText);
         finalUrl = chatCEURL+classifierdomain;
         }
         else
         {
        	 finalUrl = myurl
         }
         console.log("chat ce part calling for " + classifierdomain);
         $.ajax({
             url: finalUrl+ "/advchatCE",
             type: 'POST',
             data: JSON.stringify(json),
             cache: false,
             beforeSend: function(xhr) {
             ...
             success: function(response) {
                 $('#userInputText').focus();
                 $('.yesNoBtn').addClass('disabled');
                 $(".yesNoBtn").attr('disabled', 'disabled');
                 showSeparator = false;
                 $('.ibanShowMoreBtn').css('-webkit-animation', 'none');
                 $('.ibanShowMoreBtnEverAnimated').css('-webkit-animation', 'none');
                 ...
                 response.errorText = response.errorText.replace(/ngGenie/g, brandName);
                 isnonOntoResGen = response.isNonOntoResGen;
                 isNonOntoWorkflow = response.isNonOntoWorkflow;
                 scriptId = response.scriptId;
                 if(isnonOntoResGen == "true" && response.forceConfirmation == "yes")
                 {
                	 $('#userInputText').prop('disabled',true);
                 }
                 ...
                 expertTransactionId = response.transactionId ;
                 
                 if (resVal.indexOf("connectVirtualSME") != -1)
                  {
                	 var url = "ws://localhost:8009/";
                     ...
                     socket.onopen = function () {
                      var message ={
                                      from: 'CE',
                                     cmd : 'Start_VSME',
                                     script : response.scriptId
                               };       
                     socket.send(JSON.stringify(message)); 
                	 
                  }

                  } else if (resVal.indexOf("ticket number") != -1 || resVal.indexOf("Sorry I do not have this information at this point of time.") != -1 || resVal.indexOf("Apologies for not able to help you today") != -1 || resVal.indexOf("connectRemoteSME") != -1) {
                     ...
                     var initMsg;
					 var preinitMsg = "genie user wants to start conversation";
                     ...
                     firebase.database().ref(rsmeGrpName+'/fe_engineers/' + rsmeUserName).set({
                         id: rsmeUserId,
                         skills: rsmeSkills,
                         status: 1
                     ...
                     getAvailableExpert(rsmeUserId, rsmeGrpName,rsmePrgName,rsmeSkillName);
                     if (expert != null) {
                         ...
                         for (var i = 0; i < list.length; i++) {
                             ...
                             if (child.nodeName == "DIV") {
                                 ...
                                 if (innerhtml.indexOf("<div id=\"genieText\" class=\"bubble\">") != -1) {
                                     ...
                                     var value = insertstring(innerhtml, len, "mybuddy:");
                         ...
                         isexpertSet = true;
                         startCallTime = moment(new Date());
                         var msg = {
                             loc: rsmeLoc,
                             loginID: rsmeUserId,
                             name: rsmeUserName,
                             team: rsmeTeam,
                             text: $("#conversationSection")[0].innerHTML+ "<br>The Chat History is Correspnding to Transaction ID:"+ transactionId,
                             type: 1
                         ...
                         firebase.database().ref(rsmeGrpName).child("messages").child(expert + "_chatID").push(dlvmsg);
                         ...
                         for (var i = 0; i < list.length; i++) {
                             ...
                             if (child.nodeName == "DIV") {
                                 var innerhtml = child.innerHTML;
                                 if (innerhtml.indexOf("<div id=\"genieText\" class=\"bubble\">") != -1) {
                                     var value = innerhtml.replace(brandName+":", "")
                                     child.innerHTML = value;
                                 }
                                 if (innerhtml.indexOf("<div id=\"userText\" class=\"bubble bubble--alt\">") != -1) {
                         ...
                         isLiveChat = true;
                         issecondAvailInit = true;
                         /*                                  var iconelem = document.getElementById("livechaticon");
                                                          iconelem.parentNode.style.display = "block";	 */
                         /*                                  var callelem = document.getElementById("callagenticon");
                                                          callelem.parentNode.style.display = "block"; */
                         $('#endLiveChatDiv').css('display', 'block');
                         fixScroll();

                         var html = '<table style="text-align:center; height:' + iframeRequiredHeight + '; width:100%; background: white; /* For browsers that do not support gradients */background: -webkit-radial-gradient(white, grey, black); /* Safari 5.1 to 6.0 */background: -o-radial-gradient(white, grey, black); /* For Opera 11.6 to 12.0 */background: -moz-radial-gradient(white, grey, black); /* For Firefox 3.6 to 15 */background: radial-gradient(white, white, grey, black); /* Standard syntax */"><tbody><tr><td><div><img src="resources/images/ProfileDummy-Default.png"></div><div><input type="image" title="Call Agent" id="callExpertBtn" src="resources/images/CallExpert-Default.png" name="callagenticon" value="Submit" onclick="return callagent(event);"></div></td></tr></tbody></table>';
                         $('#iframe_callback').replaceWith(html);
                         $('#remoteSMEFooterText').text('Remote Subject Mater Expert');
                         // $('#iframe_callback').prop('src',getContextPath() + "/resources/docs/html/CallAgent.html");
                         submitLiveChatData(expertTransactionId, "<font color=#00A8FF size=2 face=verdana >$mybuddy : </font>" + textVal);

                         window.expertName = remoteexpertName;
                         window.expertId = expert;

                         window.expertUserId = rsmeUserId;
                         window.expertUserName = rsmeUserName;
                         window.expertTicketId = userticketId;
                         window.cetransactionId = expertTransactionId;
                         popups();
                         showChat(false);
                     }
                 ...
                 if (isexpertSet == false) {
                     var resp = "We tried to contact Live experts for your query but as all Experts are busy in other calls we could not connect.Please try again after sometime.";
                     ...
                     fixScroll();
                     submitLiveChatData(expertTransactionId, "<font color=#00A8FF size=2 face=verdana >$mybuddy : </font>" + resp);
                     isLiveChat = false;
                     issecondAvailInit = false;
                     $('#transactionId').val('');
					 isRequestSend = 0;
                     return true;
                 }
                     ...
                     if (initializeFireBase) {
                         liveRes = firebase.database().ref(rsmeGrpName+'/messages/' + rsmeUserId + '_chatID');
                         ...
                         liveRes.on('child_added', function(snapshot) {
                             ...
                             var textVal = snapshot.val().text;

                             if (textVal == "User Query is Resolved") {
                            	 ...
                            	 updateAvailabilityService(rsmeUserId);
                                 /*                                  var elem = document.getElementById("livechaticon");
                                                                  elem.parentNode.style.display = "none"; */
                                 /*                                  var callelem = document.getElementById("callagenticon");
                                                                  callelem.parentNode.style.display = "none"; */
                                 $('#endLiveChatDiv').css('display', 'none');
                                 $("#conversationSection").css("height", "100%");
                                 isLiveChat = false;
                                 $("#conversationSection").append("<Div><div id='genieText'  class='livechatbubble'>" + "Ticket is marked resolved.Expert is offline now" + "</div></Div>");
                                 var newscrollHeight = document.getElementById('conversationSection').scrollHeight - 20; //Scroll height after the request
                                 /*                                  if (newscrollHeight > oldscrollHeight) {
                                                                      $("#conversationSection").css({
                                                                          "position": "relative"
                                 ...
                                 updateTicketStatus(expertTransactionId, userticketId);
                                 $('#transactionId').val('');
                                 fixScroll();
                                 showChat(true);


                             }else if (textVal == "conversation request accepted") {
							 firebase.database().ref(rsmeGrpName).child("messages").child(expert + "_chatID").push(initMsg);
							 }
							 
							 else if (textVal == "conversation request rejected") {
							 $("#conversationSection").append("<Div><div id='genieText'  class='livechatbubble'>" + "Available expert could not continue with the call and has rejected it.Please try again after sometime" + "</div></Div>");
                                 var newscrollHeight = document.getElementById('conversationSection').scrollHeight - 20;             
                                 fixScroll();
								 showChat(true);
								 isLiveChat = false;
							 } else if(textVal == "CallReq" || textVal == "MissedCall"){ }                            	
                              else {
                             ...
                             submitLiveChatData(expertTransactionId, "<font color=#00A8FF size=2 face=verdana >$Expert : </font>" + snapshot.val().text)
                             var refForRemoving = firebase.database().ref(rsmeGrpName+"/").child('messages/' + rsmeUserId + '_chatID');
                     ...
                     if (issecondInit && issecondAvailInit) {
                         resVal = "You can continue chatting with Expert.";
                         showSeparator = true;
                     } else if (issecondInit) {
                         resVal = "You can continue chatting with mybuddy.";
                         showSeparator = false;
                     } else {
                         resVal = "We are in the process of connecting you to Live Expert for your query.Please hold on";
                         showSeparator = true;
                     }
                     submitLiveChatData(expertTransactionId, "<font color=#00A8FF size=2 face=verdana >$mybuddy : </font>" + resVal);
                 }

                     else if (resVal.toLowerCase() == "good bye" && window.location.href.indexOf("hi_IN") != -1) {
                 ...
                 } else if (response.errorText.search("(Yes/No)") >= 0 || response.errorText.search("(Yes / No)") >= 0) {
                     var html = "<br><input class='yesNoBtn' type='button' id='yesBtn' value='Yes' onclick='getYesNo(event);'/>&nbsp;&nbsp;<input class='yesNoBtn' type='button' id='noBtn'  value='No' onclick='getYesNo(event);'/>";
                     var erText = response.errorText.replace("(Yes/No)", html);
                     erText = response.errorText.replace("(Yes / No)", html);
                     $("#conversationSection").append("<Div><div id='genieText'  class='bubble'>" + erText + "</div></Div>");
                     ...
                     if (showSeparator)
                         $("#conversationSection").append('<div style="clear: both;"><hr class="chatSeparator"></div>');
 ...
 function getYesNo(event) {
     ...
     var res = $('#' + yesNo).val();
     $("#userInputText").removeAttr('disabled');
     var userInputText = $('#userInputText').val(res);
     $('.yesNoBtn').addClass('disabled'); //remove hover effect and click events after the button has been clicked.......Not widely Supported. Not in <IE11
     $(".yesNoBtn").attr('disabled', 'disabled');
 ...
 function resetForm() {
     ...
     $('#endLiveChatDiv').css('display', 'none');
     $("#conversationSection").css("height", "100%");
     submitLiveChatData(expertTransactionId, "<font color=#00A8FF size=2 face=verdana >$mybuddy : </font>" + "'my buddy' User went offline");
     isLiveChat = false;
     showChat(true);
     $('#transactionId').val('');
     ...
     var html = '<div><div id="genieText" class="bubble">I am mybuddy, How may I help you?</div></div>';
     $("#conversationSection").append($(html));
 ...
 function hideActiveAlerts() {
     ...
     if ($("#transactionId").val() != '')
         showChatMiniMaximizer(showChatInitValue);

     if ($('.ibanShowMoreBtn').css('display') == 'none')
         $('.ibanShowMoreBtn').css('display', 'inline-block')
 }
 ...
 function setTbl() {
     ...
     $("#1").height((h / 10) * 1);
     $("#2").height((h / 10) * 0.5);
     if ($(window).height() <= 680 && $(window).height() > 480 && isMobile.any()) {
         var width = $(window).width();
         var height = $(window).height();
         $("#3").height((h / 10) * 4.5);
         if (onlykeypad == 1) {
     ...
     } else if ($(window).height() <= 480 && $(window).height() > 180 && isMobile.any()) {
         var width = $(window).width();
         var height = $(window).height();
         $("#3").height((h / 10) * 2);
         if (onlykeypad == 1) {
     ...
     } else if ($(window).height() <= 180 && isMobile.any()) {
 ...
 function dropdowncontenthidefunction() {
     var options = {};
     $("#queryArea *").removeClass("disabled");
     $("#queryArea *").removeAttr("disabled");
     if ($("#form_effect").is(':visible'))
         $("#form_effect").toggle("slide", options, 500);

     if (ToggleSelector == 1 || ToggleSelector == 2)
         hideActiveAlerts();
     $('.MenuDropDownBox-Content').css('display', 'none');
     $('.GenieOptionsDropDownBox-Content').css('display', 'none');
     $('.clearchatbutton').attr('src', 'resources/images/ClearChat-Disabled.png').attr('data-swap', 'resources/images/ClearChat-Enabled.png');
     $('.ClearChatRow').css('pointer-events', 'none');
     carouselNumber = -1;
     setTimeout(function() {
         $('.MenuDropDownBox-Content').removeAttr('style');
         $('.GenieOptionsDropDownBox-Content').removeAttr('style');
     }, 50);
 }
 ...
 function stoplivechat(ev) {
     ...
     var msg = {
         ...
         name: rsmeUserName,
         team: rsmeTeam,
         text: "'my buddy' User went offline",
         type: 1
 ...
 function callagent(ev) {
     showChat(false);
 }

 function showChatMiniMaximizer(init) {
     var options = {};
     if (init == 'init')
         init = showChatInitValue;
     else
         showChatInitValue = init;

     if (!$("#form_effect_for_SME").is(':visible')) {
         $('#maximizeRemoteSMEButton').prop('src', 'resources/images/AvatarMinimize-Default.png');
         $('#maximizeRemoteSMEButton').prop('id', 'minimizeRemoteSMEButton');
     } else {
         $('#minimizeRemoteSMEButton').prop('src', 'resources/images/AvatarMaximize-Default.png');
         $('#minimizeRemoteSMEButton').prop('id', 'maximizeRemoteSMEButton');
         $("#form_effect_for_SME").toggle("slide", options, 500);
     }
     showChat(showChatInitValue);
 }

 function showChatresizer() {
     var dialogueTotalHeight = $('.ui-dialog').css("height").replace('px', '');
     var dialogueHeaderHeight = $('.ui-dialog-titlebar').css("height").replace('px', '');
     var footerHeight = $('#tblQueryArea').css("height").replace('px', '');
     var requiredFrameHeight = dialogueTotalHeight - dialogueHeaderHeight - footerHeight;

     iframeRequiredHeight = requiredFrameHeight + "px";
     $('#iframe_callback').css('height', iframeRequiredHeight);
     $("#form_effect_for_SME").css("height", dialogueTotalHeight);
 }

 function showChat(init) {
     if (init == 'init')
         init = showChatInitValue;
     else
         showChatInitValue = init;
     ...
     iframe.name = "myframe";
     iframe.width = "100%";
     iframe.height = requiredFrameHeight + 'px';
     //iframe.style.margin = "1px";
     iframe.scrolling = "no";
     iframe.overflow = "hidden";
     //iframe.style.backgroundColor = "#e2e2e2";

     iframeRequiredHeight = iframe.height;

     if (init == true)
         iframe.src = getContextPath() + "/resources/docs/html/Avatar.html";
     else {
         iframe.src = getContextPath() + "/index.html#/messages/";
     /*	 if(rsmeWindow == null || rsmeWindow == 'undefined')
		 {
		 
		  rsmeWindow =  window.open("http://localhost:8080/HMIPlatformUIBase/index.html#/messages/expertName="+window.expertName+"&expertId="+window.expertId+"&expertUserId="+window.expertUserId+"&expertUserName="+window.expertUserName+"&cetransactionId="+window.cetransactionId,'_blank','toolbar=no,location=no,status=no,menubar=no,scrollbars=no,resizable=no,top=65,left=630,width=600,height='+(dialogueTotalHeight - 57));
		  
		   $("#conversationSection").append("<Div><div id='genieText'  class='livechatbubble'>" + "While you are typing, expert audio/video call window will be minimized due to web security issues" + "</div></Div>");
			var newscrollHeight = document.getElementById('conversationSection').scrollHeight - 20;
		 } */
     }
     $("#form_effect_for_SME").empty();
     var options = {};
     var position = GetDialogLocation();
     var Size = GetDialogTopHeight();
     ...
     var checkMobileWidth = changeTogglerWidth();
     if (checkMobileWidth != 0) {
         $("#form_effect_for_SME").css("width", checkMobileWidth);
     }

     var headerBackgroundColor = $('.ui-dialog-titlebar').css("background-color");
     var footerBackgroundColor = $('#tblQueryArea').css("background-color");


     var headerhtml = '<table class="dialogueTable" style="height:' + dialogueHeaderHeight + 'px; background:' + headerBackgroundColor + ';"><tbody><tr><td><span id="remoteSMEHeaderText">Virtual SME</span></td><td><div style="float:right; margin-bottom: 25px;"><a href="javascript:void(0);"><img src="resources/images/Minimize-Default.png" id="remoteSMEMinimizeButton" onclick="javascript:showChatMiniMaximizer(\'init\');"></a><a href="javascript:void(0);"><img src="resources/images/Close-Default.png" id="remoteSMECloseButton" onclick="javascript:showChatMiniMaximizer(\'init\');"></a></div></td></tr></tbody></table>';
     var footerhtml = '<table class="dialogueTable" style="height:' + footerHeight + 'px; background:' + footerBackgroundColor + ';"><tbody><tr style="border-top: 1px solid black"><td style="text-align:center;"><span id="remoteSMEFooterText">Your Virtual Personal Assistant : \'mybuddy\'</span></td></tr></tbody></table>';

     $('#form_effect_for_SME').append(headerhtml);
     $('#form_effect_for_SME').append(iframe);
     $('#form_effect_for_SME').append(footerhtml);
     $("#form_effect_for_SME").css("height", dialogueTotalHeight);
     if (!$("#form_effect_for_SME").is(':visible')) {
         setTimeout(function() {
             $("#form_effect_for_SME").toggle('slide', {
                 direction: 'left'
             }, 500);
     ...
     //iframe.src="https://nggenieqa.wipro.com:8443/myrequestweb/dialogue?us";
 ...
 function fixScroll() {
     if ($('#conversationSection').attr('style')) {
         $('#conversationSection').attr('style', function(i, style) {
             return style.replace(/height[^;]+;?/g, '');
         });
     }
     $("#conversationSection").css("height", "100%");
     var conversationSection = $('#conversationSection');
     var heightOfConvSec = conversationSection[0].scrollHeight;
     var heightOfEndLiveChatDiv = '';
     if ($('#endLiveChatDiv').is(':visible')) {
         heightOfEndLiveChatDiv = $('#endLiveChatDiv').outerHeight(true);
         $("#conversationSection").css("height", "96%");
     }

     var heightToScroll = heightOfConvSec + heightOfEndLiveChatDiv;
     $("#conversationSection").animate({
 ...
 function changeFormLocation() {
     var left = $('.ui-dialog').offset().left;
     var chatwindowWidth = $('.ui-dialog').width();
     var windowWidth = $(window).width();
     var formWidth = '';
     var smeFormWidth = '';

     if ($("#form_effect").is(':visible'))
         formWidth = $('#form_effect').width();
     if ($("#form_effect_for_SME").is(':visible'))
         smeFormWidth = $('#form_effect_for_SME').width();

     if ((windowWidth - chatwindowWidth - left) < formWidth) {
         $("#divToggler").css("padding-left", "");
         $("#divToggler").css("margin-left", "-" + formWidth + "px");
     } else if ((windowWidth - chatwindowWidth - left) < smeFormWidth) {
         $("#divToggler").css("padding-left", "");
         $("#divToggler").css("margin-left", "-" + smeFormWidth + "px");
     } else {
         $("#divToggler").css("margin-left", "");
         $("#divToggler").css("padding-left", chatwindowWidth);
     }
 }

 function popups() {
     if (isGenieSpeakingCheckEnabled == true)
         talk($("#genieText.bubble").last().text());
     $('.popup-image-vertical-fit').magnificPopup({
         type: 'image',
     ...
     $('.popup-image-no-margins').magnificPopup({
         type: 'image',
         closeOnContentClick: true,
         				...
         				iframe: {
         					patterns: {
         						youtube: {
         							index: 'youtube.com/', 
         							id: 'xuA5X_Cyw-A',
         							src: '//www.youtube.com/embed/'+'xuA5X_Cyw-A'+'?autoplay=1'
         						},
         						vimeo: {
         							index: 'vimeo.com/', 
         							id: function(url) { */
     ...
     $('.popup-image-animations').magnificPopup({
         delegate: 'a',
         type: 'image',
         removalDelay: 500, //delay removal by X to allow out-animation
         callbacks: {
 ...
 function getAvailableExpert(enggId, groupName,expertProgramName,expertSkillName) {
	 var urlVal = getconfigParam("availabilitysvcurl");
	 window.updateServiceUrl = getconfigParam("availabilityupdateurl");
     var json = {
		 "enggId":enggId,
		 "groupName":groupName,
		 "expertProgramName":expertProgramName,
     ...
     $.ajax({
         ...
         success: function(response) {
			...
			var id = response.loginId;
			expert = id;
			var name = response.name;
			remoteexpertName = name;
         },
         error: function(xhr, status, error) {
             alert("Expert Availability service seems to be down.Please contact admin.");
         }
     });
     
 }
     
   function updateAvailabilityService(enggId)
    {
	   var urlVal = getconfigParam("availabilityupdateurl");
	   var now = moment(new Date());
	   var duration = moment.duration(now.diff(startCallTime));
	   var seconds = duration.asSeconds();
	   var jsonData = {
	      		  "enggId":enggId,
	      		  "expertId":expert,
	      		  "callStartDate":moment(startCallTime).format("YYYY-MM-DD HH:mm:ss"),
	      		  "callEndDate":moment(now).format("YYYY-MM-DD HH:mm:ss"),
	      		  "callDuration":Math.round(seconds),
	      		  "active":0
	      		}
   ...
   function getClassifierDomain(utterance){

	   if(chatCEURL == "")
	    chatCEURL = getconfigParam("chatceurl");
		var tempURL = myurl+'getClassifierDomain/'+JSON.stringify(utterance);
		$.ajax({
	        url: tempURL,
	        type: 'POST',        
	        data: '',
	        ...
	        success:function(response){ 
	        	...
	        	classifierdomain = obj.prediction;
	        },
			error : function(xhr, status, error) {
				alert(xhr.responseText);
			}
