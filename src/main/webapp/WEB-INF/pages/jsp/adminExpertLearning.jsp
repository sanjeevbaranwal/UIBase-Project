...
#agent:hover{
	background-color:white;
		...
		<script src="resources/js/adminExpertlearning.js"></script>
						...
						<td id="tabRow1" class="chartCss" BGCOLOR="#FFFFFF" >
							<div id="sltbl">
								 <ul class="nav nav-tabs ">
                                     <li class="active"><a data-toggle="tab" id="present" href="#present1" onclick="checkNavChange(event);">UnAttended Learnings</a></li>
                                     <li ><a data-toggle="tab" id="past" href="#past1" onclick="checkNavChange(event);">Attended Learnings</a></li>
										...
										<div class="panel-group" id="accordionToday">
											<div class="panel panel-default">
												<div class="panel-heading" data-toggle="collapse" data-parent="#accordionToday" href="#collapseOneToday" style="cursor:pointer;">
													<h4 class="panel-title">
														Today's Learnings<span class="glyphicon glyphicon-chevron-down pull-right"></span>
													</h4>
												</div>
											...
											<div class="panel panel-default">
												<div class="panel-heading" data-toggle="collapse" data-parent="#accordionToday" href="#collapseTwoToday" style="cursor:pointer;">
													<h4 class="panel-title">
														Past Learnings<span class="glyphicon glyphicon-chevron-down pull-right"></span>
													</h4>
												</div>
										...
										<div class="panel-group" id="accordionPast">
											<div class="panel panel-default">
												<div class="panel-heading" data-toggle="collapse" data-parent="#accordionPast" href="#collapseOnePast" style="cursor:pointer;">
													<h4 class="panel-title">
														Approved Learnings<span class="glyphicon glyphicon-chevron-down pull-right"></span>
													</h4>
												</div>
											...
											<div class="panel panel-default">
												<div class="panel-heading" data-toggle="collapse" data-parent="#accordionPast" href="#collapseTwoPast" style="cursor:pointer;">
													<h4 class="panel-title">
														Rejected Learnings<span class="glyphicon glyphicon-chevron-down pull-right"></span>
													</h4>
												</div>
