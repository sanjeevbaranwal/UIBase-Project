...
<script src="resources/js/KBSearchResultDetails.js"></script>
	...
	<form>
		...
		<div id="divLoading"
			...
			<p style="position: absolute; color: White; top: 50%; left: 45%;">
				Loading, please wait... <img src="resources/images/ajax-loader.gif">
			</p>
		</div>


		<div style="padding-top: 0.2cm">
			<table class="container text-center" cellpadding="0" cellspacing="0"
				border=0>
				<tr>
					<td colspan=3>
						<div class="well" align="left" style="padding: 5px">
							<div class="container-fluid"
								...
								<table width="100%" border=0>
									<tr>
										<td style="padding-right: 0.2cm; width: 15%;"><font
											color="#003E7C">Upload KB article <font></td>
									 ...
									 -->
										...
										<td style="padding-right: 0.2cm; width: 20%;" align="right">
											<c:if
												...
												<font color="#003E7C"> Welcome :
													${pageContext.request.userPrincipal.name} |</font>
												<a href="<c:url value="j_spring_security_logout" />"> <font
													color="Red" size="2">Logout</font>
												</a>
												</font>
									...
									<tr>
										<td style="padding-right: 0.5cm" colspan=1 height="20px"><a
											href="#" onclick="parent.location='KBSearchResults'"><i>Back
													to KB Search Results</i> </a></font>
										</div></td>
										<td style="padding-right: 0.5cm" colspan=3 height="20px"><div
												id="ajax_message"></div></td>
									</tr>
								</table>
							</div>
						</div>
					...
					<td>
						<div class="well" align="left" style="padding: 10px">
							<table border=0>
								<tr>
									<td>Problem Type&nbsp;&nbsp;</td>
									<td width="70%"><select id="appSelect"></select></td>
								</tr>

								<tr>
									<td style="padding-top: 0.2cm">
										<button type="button" class="btn  btn-primary btn-xs"
											id="but_prodesc" onclick="addProbType(this.id)">Add
											New</button>
									</td>
									<td width="70%" style="padding-top: 0.2cm"><input
										type="text" readonly id="prodesc"></td>
								</tr>
							</table>
						...
						<div class="well" align="left" style="padding: 10px">
							...
							<table border=0 width="100%">
								<tr>
									<td>Issue Type&nbsp;&nbsp;</td>
									<td width="70%" style="padding-top: 0.2cm" rowspan=2><textarea
											rows="5" cols="30" id="quedesc" readonly></textarea></td>

								</tr>
								<tr>
									<td style="padding-top: 0.2cm">
										<button type="button" class="btn  btn-primary btn-xs"
											id="but_quedesc" onclick="editTextArea(this.id)">Edit</button>
									</td>
						...
						<div class="well" align="left" style="padding: 10px">
							<table cellspacing=20>
								<tr>
									<td>Mandatory words <br> <textarea rows="3" cols="20"
											readonly id="manwords"></textarea> <br>
										<button type="button" class="btn btn-primary btn-xs"
											id="but_manwords" onclick="editTextArea(this.id)">Edit</button>
									</td>
									<td>&nbsp;</td>
									<td>Data Required <br> <textarea rows="3" cols="20"
											id="datareq" readonly></textarea> <br>
										<button type="button" class="btn btn-primary btn-xs"
											id="but_datareq" onclick="editTextArea(this.id)">Edit</button>
									</td>
							...
							<tr>
								<td style="padding-left: 0.2cm">
									<div class="well" align="left">
										...
										<br />
										<button type="button" class="btn btn-primary btn-xs"
											id="but_answer" onclick="editTextArea(this.id)">Edit</button>
									</div>
								</td>
								<td style="padding-left: 0.2cm">
									<div class="well" align="left">
										...
										<br />
										<button type="button" class="btn btn-primary btn-xs"
											id="but_addinfo" onclick="editTextArea(this.id)">Edit</button>
									</div>
								</td>
							...
							<tr>
								<td style="padding-left: 0.2cm" colspan=2>
									<div class="well" align="center">
										<button type="button" class="btn btn-primary" id="but_addart"
											onClick="addArticle()">Add new article</button>
									</div>
								</td>
							</tr>
						</table>
